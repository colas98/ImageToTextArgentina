...
def preprocess_image(img, parameters):
    ...
    if parameters['GeneralParameters']['ResizingImage'] is True and parameters['AdvancedParameters']['ResizingMethod'] is not None:
    ...
    if parameters['GeneralParameters']['ThresholdingImage']  is True and parameters['AdvancedParameters']['ThresholdingMethod'] is not None:
