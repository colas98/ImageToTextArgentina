...
class Ui_Screen3(object):
    ...
    def __init__(self, dict_parameters):
        ...
        self.num_pages_book = len(PyPDF2.PdfReader(self.dict_parameters['Paths']['BookFile']).pages)
    def setupUi(self, MainWindow):
        ...
        self.RunBookPushButton.setGeometry(QtCore.QRect(790, 430, 151, 71))
        self.RunBookPushButton.setStyleSheet("background: rgb(255, 255, 255)")
        self.RunBookPushButton.setIcon(icon)
        self.RunBookPushButton.setObjectName("RunBookPushButton")
        self.RunBookPushButton.setEnabled(False)
    ...
    def runLongTask(self):
        ...
        self.thread.finished.connect(
            lambda: self.RunBookPushButton.setEnabled(True)
        )
    ...
    def refresh(self):
        ...
        time_scan_book = round(self.num_pages_book * time_per_page)
        self.TimeScanLabel.setText(f"Time estimated of scanning full book: {time_scan_book} sec")
